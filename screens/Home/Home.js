...
const Home = ({ route, navigation }) => {
  ...
  const Box2 = ({ separator, title, count }) => {
    return (
      <View style={styles.horizontalView}>
        ...
        {loaded ? (
          <View style={styles.dataContainer}>
            <View style={styles.horizontalView}>
              <View>
                <HeadingComponent />
                <Box2 separator title="TRIPS" count={data.day[1].y} />
              </View>
              <View style={styles.horizontalView}>
            ...
            <View style={{ marginTop: hp(1), flexDirection: "row" }}>
              <Box2 title="TOTAL EARNINGS" count={data.day[0].y} separator />
              <Box3 count={data.week[0].y} separator />
              <Box3 count={data.month[0].y} />
            </View>
            <View style={{ marginTop: hp(1), flexDirection: "row" }}>
              <Box2 title="MILES/HR" count={data.day[2].y} separator />
